import { mockProjMobile } from "../mock/mock_projectMobile.js";

window.addEventListener("load", () => {
  const pg_project = document.getElementById("pg_projectsMobile");

  mockProjMobile.forEach((project) => {
    ...
    projectsDiv.classList.add("projects_mobile");

    let img = document.createElement("img"); // Imagem padrão

    img.classList.add("img_mobile");
