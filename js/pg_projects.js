import { mockProj } from "../mock/mock_project.js";

window.addEventListener("load", () => {
  const pg_project = document.getElementById("pg_projects");

  mockProj.forEach((project) => {
    ...
    if (project.id == 1) {
      img.classList.add("img_projects_app");
    } else {
